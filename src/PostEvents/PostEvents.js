...
export default function PostEvents() {
    ...
    const onFinish = async (values) => {
        try {
            ...
            formData.append("participationType", values.participationType || "");
            if (values.participationType === "Team") {
                formData.append("memberLimit", values.memberLimit || "");
            }
            formData.append("eligibility", JSON.stringify(eligibilityList || []));
            formData.append("winnerPrize", values.winnerPrize || "");
            formData.append("runnerPrize", values.runnerPrize || "");
